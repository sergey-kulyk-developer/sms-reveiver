...
import com.sergeykulyk.smsreceiver.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun registerSmsReceiver() {
        ...
        val smsReceiver = SmsReceiver("Triare", "\\d{2}-\\d{2}-\\d{2}") { message ->
            binding.firstPinView.setText(message?.replace("-", ""))
        }
